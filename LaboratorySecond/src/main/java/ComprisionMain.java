...
//        dataHolder.loadDataFromFile("/home/albert/IdeaProjects/DataCodingAndCompression/LaboratorySecond/src/main/java/tets/test.txt");

//        dataHolder.getSignOnOccurrences().forEach((k,v)->{
